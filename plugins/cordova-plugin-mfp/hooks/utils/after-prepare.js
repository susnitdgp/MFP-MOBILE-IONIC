...
AfterPrepare.prototype.buildStaticAppProps = function(appProps,
    ...
    appProps.MESSAGES_DIR = hookConsts.MESSAGES_PATH.replace(/\\/g, '/');//APAR 119550 - on windows machine path is getting formed with '\' instead of '/' for ex: plugins\cordova-plugin-mfp\worklight\messages, replace path with '/'
